    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex h-16 items-center justify-between">
            <div class="flex items-center">
                ...
                <img class="size-8" src="https://upload.wikimedia.org/wikipedia/commons/d/d5/Tailwind_CSS_Logo.svg" alt="Tailwind Logo">
                </div>
                    ...
                    <?php if ($_SESSION['user'] ?? false) : ?>
                        <div class="relative ml-3">
                            <button type="button"
                                ...
                                <a href="/"><img class="h-8 w-8 rounded-full"
                                     src="https://icons.veryicon.com/png/o/miscellaneous/effevo/member-50.png"
                                     alt=""></a>
                            </button>
                        </div>
